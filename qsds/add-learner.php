...
// This script takes the licence number of a learner,
// adds the relation in the database.
// Provides appropriate feed back via GET to view-learners.php

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $licenceNumber = $_POST["learner-ln-input"];
    $supervisorID = $_SESSION["userID"];
    $sql = "SELECT id, supervisor, instructor, government FROM Users WHERE licenceNo = '$licenceNumber';";
